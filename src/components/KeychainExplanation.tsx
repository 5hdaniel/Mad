        ...
        <div className="p-6">
          {isLoading ? (
            <div className="text-center py-6">
              ...
              <p className="text-gray-600 text-sm">Please enter your password in the system dialog...</p>
            </div>
          ) : (
            <>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-blue-700">
                    Click <strong>"Always Allow"</strong> on the system dialog to avoid entering your password each time.
                  </p>
                </div>
              </div>
