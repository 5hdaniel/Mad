...
function PermissionsScreen({
  ...
  const [findPrivacySecurityComplete, setFindPrivacySecurityComplete] =
    useState(false);
  const [findFullDiskAccessComplete, setFindFullDiskAccessComplete] =
    useState(false);
        ...
        <div className="max-w-2xl mx-auto p-8 bg-white rounded-lg shadow-lg">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Welcome to Real Estate Archive
            </h1>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <div className="flex items-start text-sm text-gray-700">
              ...
              <span>
                <strong>Full Disk Access</strong> - To read your Messages
                database. This is a macOS security requirement for accessing
                iMessage data.
              </span>
            </div>
          </div>
  ...
  return (
    <div className="flex items-center justify-center min-h-full py-8">
      <div className="max-w-2xl mx-auto p-8 bg-white rounded-lg shadow-lg">
        ...
        <div
          className={`border-2 rounded-lg p-6 mb-6 transition-all ${
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 mb-1">
                    {findPrivacySecurityComplete
                      ...
                      : "Find Privacy & Security in Sidebar"}
                  </h3>
                  {!findPrivacySecurityComplete && (
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start flex-1">
                ...
                <div className="flex-1">
                  ...
                  {!findFullDiskAccessComplete && (
                    <p className="text-sm text-gray-700">
                      In the Privacy & Security section, scroll down and click
                      on <strong>"Full Disk Access"</strong>
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start flex-1">
                ...
                <div className="flex-1">
                  ...
                  {!clickPlusComplete && (
                    <p className="text-sm text-gray-700">
                      Click the <strong>+ (plus)</strong> button to add a new
                      application to the Full Disk Access list
                    </p>
                  )}
                </div>
              </div>
                  ...
                  {!selectAppComplete && (
                    <>
                      <p className="text-sm text-gray-700 mb-2">
                        In the file selector that opens, navigate to{" "}
                        <strong>Applications</strong> and select{" "}
                        <strong>Real Estate Archive.app</strong>
                      </p>
                      <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-xs text-blue-800">
                          <strong>💡 Tip:</strong> If you can't find Real Estate
                          Archive in the Applications folder, you may not have
                          copied it from the DMG file. Drag the app from the DMG
                          to your Applications folder first.
                        </p>
                      </div>
                    </>
                  )}
                  ...
                  {!quitReopenComplete && (
                    <>
                      <p className="text-sm text-gray-700 mb-3">
                        ...
                        <strong>
                          "Real Estate Archive" will not have full disk access
                          until it is quit.
                        </strong>
                      </p>
                      <p className="text-sm text-gray-700 mb-2">
                        Click <strong>"Quit & Reopen"</strong> to restart the
                        app with full disk access enabled
                      </p>
                      <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <p className="text-xs text-yellow-800">
                          <strong>Note:</strong> If you click "Later", you'll
                          need to manually restart the app for the permissions
                          to take effect
                        </p>
                      </div>
                    </>
        ...
        {quitReopenComplete && (
          <div className="bg-green-50 border-2 border-green-300 rounded-lg p-6 mb-6 text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              If you don't see the app, you can open it manually from your
              Applications folder. We're checking for permissions and you should
        ...
        <p className="text-center text-xs text-gray-500 mt-6">
          We'll never share your data. All exports are stored locally on your
          device.
        </p>
      </div>
    </div>
