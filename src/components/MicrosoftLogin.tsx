        ...
        <div className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-lg">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mb-4">
              Connect to Microsoft Outlook to export email communications
      ...
      <div className="max-w-md mx-auto p-8 bg-white rounded-lg shadow-lg">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">
            Sign in with your account to access email export features and
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => {
              ...
              alert(
                "Google sign-in coming soon! This feature will be available in a future update.",
              );
            }}
            disabled={isAuthenticating}
