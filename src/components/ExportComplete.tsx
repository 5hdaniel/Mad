        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6 text-left">
          <div className="space-y-3">
            ...
            <div className="bg-white px-3 py-2 rounded border border-gray-200">
              <code className="text-sm text-gray-800 break-all">{result?.exportPath || 'Unknown'}</code>
            </div>
            ...
            {hasFiles && (
              <>
                <div className="flex justify-between items-center pt-3 pb-3 border-b border-gray-200">
                  ...
                  <span className="text-sm text-gray-600">{filesCreated.length}</span>
                </div>
            ...
            {hasResults && (
              <>
                <div className="flex justify-between items-center pt-3 pb-3 border-b border-gray-200">
                  <span className="text-sm font-semibold text-gray-700">Export Results:</span>
                  <span className="text-sm text-gray-600">{results.length} contacts</span>
                </div>
