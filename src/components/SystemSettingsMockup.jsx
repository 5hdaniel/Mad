...
function ModernSystemSettings({ step, macOSVersion }) {
  ...
  return (
    <div className="mx-auto max-w-4xl mb-4">
      <div className="bg-white rounded-xl shadow-2xl overflow-hidden" style={{ height: '500px' }}>
        ...
        <div className="flex h-full">
          ...
          <div className="w-56 bg-gray-50/50 border-r border-gray-200">
            ...
            <div className="px-2 space-y-0.5 text-sm">
              <div className="px-3 py-1.5 bg-blue-500 text-white rounded-md font-medium">Privacy & Security</div>
              <div className="px-3 py-1.5 text-gray-700 hover:bg-gray-200 rounded-md cursor-pointer">General</div>
              <div className="px-3 py-1.5 text-gray-700 hover:bg-gray-200 rounded-md cursor-pointer">Appearance</div>
              <div className="px-3 py-1.5 text-gray-700 hover:bg-gray-200 rounded-md cursor-pointer">Accessibility</div>
              <div className="px-3 py-1.5 text-gray-700 hover:bg-gray-200 rounded-md cursor-pointer">Control Center</div>
              {isSequoia && <div className="px-3 py-1.5 text-gray-700 hover:bg-gray-200 rounded-md cursor-pointer">Siri & Spotlight</div>}
              <div className="px-3 py-1.5 text-gray-700 hover:bg-gray-200 rounded-md cursor-pointer">Desktop & Dock</div>
              <div className="px-3 py-1.5 text-gray-700 hover:bg-gray-200 rounded-md cursor-pointer">Displays</div>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 relative">
              <div className="max-w-2xl">
                <h2 className="text-base font-semibold text-gray-900 mb-2">Full Disk Access</h2>
                <p className="text-sm text-gray-600 mb-4">
                  Allow the apps below to access data like Mail, Messages, Safari, Home, Time Machine backups, and certain administrative settings for all users on this Mac.
                </p>
                ...
                <div className="bg-gray-50 border border-gray-300 rounded-lg overflow-hidden mb-20">
                  <div className="divide-y divide-gray-300">
                    <div className="flex items-center justify-between px-4 py-2.5 hover:bg-gray-100">
                      <span className="text-sm text-gray-900">Terminal.app</span>
                    ...
                    {(step === 'find-app' || step === 'toggle') && (
                      <div className="relative flex items-center justify-between px-4 py-2.5 bg-blue-50">
                        <span className="text-sm text-gray-900 font-medium">Electron.app</span>
                        <div className="relative">
                          <div className={`relative w-11 h-6 ${step === 'toggle' ? 'bg-green-500' : 'bg-gray-300'} rounded-full transition-colors`}>
                            <div className={`absolute ${step === 'toggle' ? 'right-1' : 'left-1'} top-1 w-4 h-4 bg-white rounded-full shadow transition-all`}></div>
                          </div>
                          {step === 'toggle' && (
                            <>
                    ...
                    {step === 'unlock' && (
                      <div className="flex items-center justify-between px-4 py-2.5 hover:bg-gray-100">
                        <span className="text-sm text-gray-900">Electron.app</span>
