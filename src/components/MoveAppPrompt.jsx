    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
        ...
        <p className="text-gray-600 mb-4 text-center text-sm leading-relaxed">
          We've detected that you're not running Real Estate Archive from the Applications folder of your machine. This could cause problems with the app, including impacting your ability to sign in.
        </p>

        <p className="text-gray-700 mb-4 text-center text-sm font-medium">
          Do you want to move Real Estate Archive to the Applications folder now? This will also restart the app.
        </p>

        {/* Current Location Info */}
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-5">
          <p className="text-xs text-yellow-800 font-medium mb-1">Current location:</p>
          <p className="text-xs text-yellow-900 font-mono break-all">{appPath}</p>
        </div>
        ...
        <div className="flex items-center mb-5">
          ...
          />
          <label htmlFor="dontShowAgain" className="ml-2 text-sm text-gray-700 select-none cursor-pointer">
        ...
        <p className="text-xs text-gray-500 text-center mt-4">
          Clicking "Move and Restart" will open the Applications folder. Please drag the app there and restart it.
        </p>
      </div>
    </div>
  );
