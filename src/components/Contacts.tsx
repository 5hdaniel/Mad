                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${getSourceBadge(contact.source).color}`}
                      >
            ...
            <div className="p-6 overflow-y-auto flex-1">
              <div className="mb-4">
                <p className="text-gray-700">
                  This contact cannot be deleted because they are associated
                  with{" "}
                  <span className="font-semibold text-red-600">
                    {blockingTransactions.length} transaction
                    {blockingTransactions.length !== 1 ? "s" : ""}
                  </span>
                  .
                </p>
              ...
              <div className="space-y-3">
                ...
                {blockingTransactions.length > 20 && (
                  <div className="text-center py-3 text-gray-600">
                    <p className="text-sm">
                      ... and {blockingTransactions.length - 20} more
                      transaction
                      {blockingTransactions.length - 20 !== 1 ? "s" : ""}
                    </p>
                  </div>
                )}
              </div>
