...
function SecureStorageSetup({ onComplete, onRetry }: SecureStorageSetupProps) {
  ...
  const handleSetup = async () => {
    ...
    try {
      const result: SecureStorageResult =
  ...
  const getPlatformSpecificText = () => {
    if (platform === "darwin") {
      return {
        ...
        description:
          "Magic Audit uses your Mac's built-in Keychain to encrypt the local database where your contacts and messages are stored.",
        promptInfo:
          'You\'ll see a system dialog asking for permission. Click "Always Allow" to grant permanent access and avoid repeated prompts.',
        touchIdNote:
          "If you have Touch ID enabled for your Keychain, you can use your fingerprint instead of entering your password.",
        icon: (
          <svg
      ...
      return {
        ...
        description:
          "Magic Audit uses Windows Data Protection API (DPAPI) to encrypt the local database where your contacts and messages are stored.",
      ...
      return {
        ...
        description:
          "Magic Audit uses your system's secure storage to encrypt the local database where your contacts and messages are stored.",
        promptInfo:
          "You may be asked to authenticate to access the secure storage.",
        touchIdNote: null,
        icon: (
          <svg
            className="w-12 h-12 text-blue-600"
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden">
        ...
        <div className="p-6">
          ...
          {status === "explanation" && (
            <>
              <div className="mb-6">
                <p className="text-gray-700 mb-4">{platformText.description}</p>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Encrypts your local database containing contacts and
                        messages
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Protects your personal data with OS-level encryption
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg
                      ...
                      <span>
                        Ensures sensitive information stays private on your
                        device
                      </span>
                    </li>
                  </ul>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700">
                      Magic Audit requires secure storage to protect your local
                      data. Without it, we cannot safely encrypt your contacts
                      and messages.
                    </p>
                  </div>
                </div>
