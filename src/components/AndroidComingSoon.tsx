...
interface AndroidComingSoonProps {
  onGoBack: () => void;
  onContinueWithEmail: () => void;
}

/**
 * AndroidComingSoon Component
 * Displays a "Coming Soon" message for Android users.
 * Offers options to go back and select iPhone, or continue with email-only features.
 */
function AndroidComingSoon({ onGoBack, onContinueWithEmail }: AndroidComingSoonProps) {
  return (
      ...
      <div className="max-w-lg w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            We're working hard to bring Android phone sync to Magic Audit. You'll be able to sync your text messages and contacts from your Android device.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-medium text-blue-900">Want to be notified?</p>
                <p className="text-xs text-blue-700">We'll email you when Android support is ready!</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-100 pt-6 mb-6">
            <p className="text-sm text-gray-500 mb-4">
              In the meantime, you can still use Magic Audit to audit your email communications. Email auditing works great on both Mac and PC!
            </p>
          </div>
          ...
          <p className="text-xs text-gray-400 mt-6">
            Have an iPhone as well? Go back and select iPhone to sync your messages today.
          </p>
        </div>
      </div>
    </div>
...
export default AndroidComingSoon;
