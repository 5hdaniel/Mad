...
// Windows: 3-step flow (Sign In already complete before this screen)
 ...
 * Phone Type is step 1 on both platforms
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-xl w-full">
        {/* Progress Indicator */}
        <SetupProgressIndicator isWindows={isWindows} />
