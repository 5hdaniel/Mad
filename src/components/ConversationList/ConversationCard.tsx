            ...
            <p className="text-sm text-gray-500 mt-1">
              {conversation.directChatCount > 0 && conversation.groupChatCount > 0 ? (
                ...
                <>
                  ...
                  {conversation.directChatCount > 1 ? 's' : ''} ({conversation.directMessageCount}{' '}
                  message{conversation.directMessageCount !== 1 ? 's' : ''}){' and '}
                  {conversation.groupChatCount} group chat thread{conversation.groupChatCount > 1 ? 's' : ''} (
                  {conversation.groupMessageCount} message{conversation.groupMessageCount !== 1 ? 's' : ''})
                </>
                ...
                <>
                  {conversation.directChatCount} direct message thread
                  {conversation.directChatCount > 1 ? 's' : ''} ({conversation.directMessageCount}{' '}
                  message{conversation.directMessageCount !== 1 ? 's' : ''})
                </>
