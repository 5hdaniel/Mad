...
function EmailOnboardingScreen({
  ...
  // Current step in progress bar - Connect Email is now step 2 for both platforms
  // New flow: Phone Type (1) → Connect Email (2) → Secure Storage (3, macOS) → Permissions (4, macOS)
  const currentStep = 2;
  const steps = isWindows ? WINDOWS_SETUP_STEPS : MACOS_SETUP_STEPS;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-8">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        {/* Secure Storage step removed - it's now a separate screen (KeychainExplanation) after email onboarding */}
        ...
        {/* Permissions step removed - it's now a separate screen (PermissionsScreen) after keychain setup */}
