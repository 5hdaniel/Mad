        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 mb-3">
              Magic Audit helps real estate professionals extract and organize
              transaction data from emails automatically.
            </p>
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center z-10 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            ...
            <p className="text-sm text-gray-700 text-center mb-6 leading-relaxed">
              We can't create an account without accepting the Privacy Policy
              and Terms and Conditions. These agreements are required to use
              Magic Audit.
            </p>
