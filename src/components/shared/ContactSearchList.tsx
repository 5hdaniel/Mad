    ...
    >
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:outline-none text-gray-900 bg-white text-sm sm:text-base"
      ...
      {showCategoryFilter && (
        <div className="flex-shrink-0 px-2 sm:px-3 py-2 border-b border-gray-100 flex items-center gap-1.5 sm:gap-2 overflow-x-auto scrollbar-hide">
          <span className="text-xs text-gray-400 mr-0.5 sm:mr-1 flex-shrink-0">Show:</span>
          <button
            type="button"
            onClick={(e) => {
              e.preventDefault();
