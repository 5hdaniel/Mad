...
describe('useConversations', () => {
  ...
  describe('initial loading', () => {
    it('should start in loading state', async () => {
      ...
      (window.electron.getConversations as jest.Mock).mockImplementation(
        () => new Promise(resolve => setTimeout(() => resolve({ success: true, conversations: [] }), 100))
      );
  ...
  describe('error handling', () => {
    ...
    it('should handle thrown errors', async () => {
      (window.electron.getConversations as jest.Mock).mockRejectedValue(new Error('Network error'));
    ...
    it('should handle non-Error thrown values', async () => {
      (window.electron.getConversations as jest.Mock).mockRejectedValue('String error');
