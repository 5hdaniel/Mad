...
function TestPlatformConsumer() {
  ...
  return (
    <div>
      ...
      <span data-testid="local-messages">
        {platform.isFeatureAvailable("localMessagesAccess").toString()}
      </span>
      <span data-testid="usb-sync">
        {platform.isFeatureAvailable("iPhoneUSBSync").toString()}
      </span>
      <span data-testid="email">
        {platform.isFeatureAvailable("emailIntegration").toString()}
      </span>
    </div>
  );
}
