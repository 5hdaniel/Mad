...
class MacOSPermissionHelper {
    ...
    async setupFullDiskAccess() {
        try {
            ...
            await electron_1.shell.openExternal(privacyURL);
    ...
    async runPermissionSetupFlow() {
        ...
        try {
            ...
            await this.showPermissionNotification('Permission Setup', 'Please enable Full Disk Access in System Preferences to continue');
...
exports.default = new MacOSPermissionHelper();
