...
exports.getContactNames = getContactNames;
exports.loadContactsFromDatabase = loadContactsFromDatabase;
...
async function getContactNames() {
    ...
    let attemptedPaths = [];
    try {
        const baseDir = path_1.default.join(process.env.HOME, CONTACTS_BASE_DIR);
        ...
        try {
            ...
            for (const dbPath of dbFiles) {
                ...
                try {
                    const db = new sqlite3_1.default.Database(dbPath, sqlite3_1.default.OPEN_READONLY);
        ...
        const defaultPath = path_1.default.join(process.env.HOME, DEFAULT_CONTACTS_DB);
...
async function loadContactsFromDatabase(contactsDbPath) {
    ...
    const phoneToContactInfo = {};
    try {
        await promises_1.default.access(contactsDbPath);
    }
    catch (error) {
    ...
    try {
        const db = new sqlite3_1.default.Database(contactsDbPath, sqlite3_1.default.OPEN_READONLY);
        const dbAll = (0, util_1.promisify)(db.all.bind(db));
        const dbClose = (0, util_1.promisify)(db.close.bind(db));
