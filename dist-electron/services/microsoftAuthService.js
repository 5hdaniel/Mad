...
class MicrosoftAuthService {
    ...
    async exchangeCodeForTokens(code, codeVerifier) {
        try {
            ...
            throw new Error(axiosError.response?.data?.error_description || 'Failed to exchange authorization code');
        }
    }
    /**
    ...
    async getMailboxInfo(accessToken) {
        try {
            const response = await axios_1.default.get('https://graph.microsoft.com/v1.0/me/mailFolders/inbox', {
                headers: {
                    Authorization: `Bearer ${accessToken}`
                }
            });
...
exports.default = new MicrosoftAuthService();
