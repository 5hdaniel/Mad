...
|------|-------|--------|----------|-----------------|----------|-----|
| TASK-1124 | 1 | TODO | - | - (est 35K) | - | - |
| TASK-1125 | 1 | TODO | - | - (est 25K) | - | - |
| TASK-1126 | 2 | TODO | - | - (est 40K) | - | - |
| TASK-1127 | 1 | TODO | - | - (est 8K) | - | - |
...
- [ ] Message-derived contacts visible in modal
- [ ] Import auto-selects contacts
- [ ] Auto-link triggers on contact add
- [ ] Phone/email hidden in modal display
...
|----|-------|----------|--------|--------|
| BACKLOG-207 | Auto-Link Communications When Contact Added | Medium | Reopened | SPRINT-045 |
| BACKLOG-306 | Hide Phone/Email in Contact Selection Modal | Low | In Sprint | SPRINT-045 |
| BACKLOG-307 | Contact Select Modal Missing Message-Derived Contacts | High | In Sprint | SPRINT-045 |
| BACKLOG-309 | Import Contact Flow - Auto-Select and Refresh Issues | High | In Sprint | SPRINT-045 |
