...
| TASK-1780 | List Attachment Filenames in Export PDF | ~15K | HIGH | 3 |

**Total Estimated (implementation):** ~165K tokens
**SR Review Overhead:** +24K (6 tasks @ ~4K each)
**Grand Total:** ~189K tokens
