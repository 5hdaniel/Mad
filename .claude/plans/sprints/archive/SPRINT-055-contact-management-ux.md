# Sprint Plan: SPRINT-055 - Contact Management UX Overhaul
...
|----|-------|-------------|-----------|
| BACKLOG-463 | Single-Screen Contact Management Flow | ~45K | TASK-1180 |

### Phase 2: Role Assignment Integration (Sequential - After Phase 1)
| ID | Title | Est. Tokens | Task File |
|----|-------|-------------|-----------|
| BACKLOG-418 | Redesign Contact Selection UX (Select First, Assign Roles Second) | ~40K | TASK-1181 |
...
|----|-------|--------|--------------|
| BACKLOG-386 | Unified Contact Selection UX | Pending | Superseded by BACKLOG-463 |
| BACKLOG-418 | Redesign Contact Selection | Pending | Phase 2 of this sprint |
| BACKLOG-311 | EditContactsModal Performance | Completed | Partial fix, superseded |
| BACKLOG-309 | Import Contact Flow Issues | Completed | Addressed by new flow |
...
|----------|-----|-------|-------------|-------|--------------|
| 1 | BACKLOG-463 | Single-Screen Contact Flow | ~45K | 1 | None |
...
|------|-------|------|-----------|
| TASK-1180 | Single-Screen Contact Management Flow | ~45K | Sequential |
...
| Task | Title | Est. | Execution |
|------|-------|------|-----------|
| TASK-1181 | Redesign Contact Selection UX | ~40K | After Phase 1 |
...
```
Phase 1:
1. TASK-1180 -> develop (PR)

Phase 2:
2. TASK-1181 -> develop (PR, after 1180 merged)
```
...
|-----------|-------|---------------|------------|
| `src/components/shared/UnifiedContactSelector.tsx` | 1180 | None | New file |
| `src/components/shared/RoleAssigner.tsx` | 1181 | None | New file |
| `src/components/ContactSelectModal.tsx` | 1180 | Medium | Replace with new component |
| `src/components/audit/ContactAssignmentStep.tsx` | 1181 | Medium | Replace with new flow |
| `src/components/transactionDetailsModule/components/modals/EditContactsModal.tsx` | 1180, 1181 | High | Phase 1 updates, Phase 2 may adjust |
...
|-------|-------|-------------|-----------|
| Phase 1: Unified Selector | 1180 | ~45K | Sequential |
| Phase 2: Role Assignment | 1181 | ~40K | Sequential |
| **Total** | **2 tasks** | **~85K** | - |
...
- [ ] Existing tests identified for update
...
|-------|------|---------|--------|----------|-----|---------------|
| 1 | TASK-1180 | BACKLOG-463 | Pending | - | - | - |
| 2 | TASK-1181 | BACKLOG-418 | Pending | - | - | - |
...
**Single-Screen Contact Flow (TASK-1180):**
...
After SPRINT-055, the following should be deprecated/removed:
...
- **BACKLOG-386**: Unified Contact Selection UX (superseded)
- **BACKLOG-418**: Redesign Contact Selection UX
- **BACKLOG-311**: EditContactsModal Performance (superseded)
