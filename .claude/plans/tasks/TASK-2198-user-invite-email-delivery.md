...
- [ ] When admin clicks "Send Invite", an email is sent to the invited user via Resend
...
- Don't add new environment variables (RESEND_API_KEY is already handled by TASK-2197)
...
- **Title**: `feat(invite): send invite email via Resend when admin invites user`
