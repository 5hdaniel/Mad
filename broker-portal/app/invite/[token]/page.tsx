...
export default function InviteAcceptPage() {
  ...
  const provider = searchParams.get('provider'); // 'microsoft' | 'google' | null
  ...
  const handleSignIn = async (authProvider: 'google' | 'azure') => {
    ...
    await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        scopes: authProvider === 'azure' ? 'email profile openid' : undefined,
      },
    });
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-4">
          <p className="text-center text-sm text-gray-600">
            Sign in as <span className="font-medium text-gray-900">{invite.email}</span> to accept
          </p>
