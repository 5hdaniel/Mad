...
const connectionStatusService =
  require("./services/connectionStatusService").default;
const macOSPermissionHelper =
...
export function registerSystemHandlers(): void {
  ...
  ipcMain.handle(
    ...
    async (): Promise<SecureStorageResponse> => {
      try {
        ...
        logService.error(
          "Secure storage status check failed",
          "SystemHandlers",
          { error: errorMessage },
        );
        return {
  ...
  ipcMain.handle(
    ...
    async (): Promise<SecureStorageResponse> => {
      ...
      try {
        ...
        logService.error("Database initialization failed", "SystemHandlers", {
          error: errorMessage,
        });
  ...
  ipcMain.handle(
    ...
    async (): Promise<{ success: boolean; hasKeyStore: boolean }> => {
      try {
        const hasKeyStore = databaseEncryptionService.hasKeyStore();
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Key store check failed", "SystemHandlers", {
          error: errorMessage,
        });
  ...
  ipcMain.handle(
    ...
    async (): Promise<{ success: boolean; initialized: boolean }> => {
      try {
  ...
  ipcMain.handle(
    ...
    async (): Promise<SystemResponse> => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Permission setup failed", "SystemHandlers", {
          error: errorMessage,
        });
        return {
          success: false,
    ...
    async (): Promise<SystemResponse> => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error(
          "Contacts permission request failed",
          "SystemHandlers",
          { error: errorMessage },
        );
        return {
  ...
  ipcMain.handle(
    ...
    async (): Promise<SystemResponse> => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Full Disk Access setup failed", "SystemHandlers", {
          error: errorMessage,
        });
        return {
          success: false,
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Failed to open privacy pane", "SystemHandlers", {
          error: errorMessage,
        });
  ...
  ipcMain.handle(
    ...
    async (): Promise<PermissionResponse> => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Full Disk Access check failed", "SystemHandlers", {
          error: errorMessage,
        });
        return {
          success: false,
  ...
  ipcMain.handle(
    ...
    async (): Promise<PermissionResponse> => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Contacts permission check failed", "SystemHandlers", {
          error: errorMessage,
        });
        return {
          success: false,
  ...
  ipcMain.handle(
    ...
    async (): Promise<SystemResponse> => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("All permissions check failed", "SystemHandlers", {
          error: errorMessage,
        });
        return {
          success: false,
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Google connection check failed", "SystemHandlers", {
          error: errorMessage,
        });
        if (error instanceof ValidationError) {
          return {
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("All connections check failed", "SystemHandlers", {
          error: errorMessage,
        });
        if (error instanceof ValidationError) {
          return {
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("System health check failed", "SystemHandlers", {
          error: errorMessage,
        });
        if (error instanceof ValidationError) {
          return {
  ...
  ipcMain.handle(
    "shell:open-external",
    async (event: IpcMainInvokeEvent, url: string): Promise<SystemResponse> => {
      try {
        // Validate URL
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Failed to open support email", "SystemHandlers", {
          error: errorMessage,
        });
        return {
          success: false,
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Failed to get user phone type", "SystemHandlers", {
          error: errorMessage,
        });
        if (error instanceof ValidationError) {
          return {
  ...
  ipcMain.handle(
    ...
    async (): Promise<{
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Unknown error";
        logService.error("Failed to get diagnostics", "SystemHandlers", {
          error: errorMessage,
        });
        return {
          success: false,
