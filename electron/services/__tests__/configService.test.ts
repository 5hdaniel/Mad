...
describe('ConfigService', () => {
  ...
  describe('setConfig', () => {
    ...
    it('should handle complex objects', async () => {
      ...
      const result = await configService.getConfig<typeof complexValue>('complex');
  ...
  describe('getMultiple', () => {
    ...
    it('should include undefined for non-existent keys', async () => {
      ...
      const result = await configService.getMultiple(['existingKey', 'nonExistentKey']);
      expect(result).toEqual({
        existingKey: 'value',
  ...
  describe('deleteConfig', () => {
    ...
    it('should handle deleting non-existent keys gracefully', async () => {
      await expect(configService.deleteConfig('nonExistent')).resolves.not.toThrow();
    });
  });
  ...
  describe('type safety', () => {
    ...
    it('should handle windowBounds object', async () => {
      ...
      const result = await configService.getConfig<typeof bounds>('windowBounds');
