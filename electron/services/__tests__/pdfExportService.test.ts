...
describe('PDFExportService', () => {
  ...
  describe('generateTransactionPDF', () => {
    ...
    it('should handle errors and cleanup window', async () => {
      ...
      const mockWindow = {
        loadURL: jest.fn().mockResolvedValue(undefined),
        webContents: {
          printToPDF: jest.fn().mockRejectedValue(new Error('PDF generation failed')),
        },
        close: jest.fn(),
      };
  ...
  describe('HTML Generation - Communications Sorting', () => {
    it('should sort communications by date descending', async () => {
      ...
      const unsortedComms = [
        { id: '1', subject: 'First', sender: 'a@b.com', sent_at: '2024-01-01T10:00:00Z' },
        { id: '2', subject: 'Third', sender: 'a@b.com', sent_at: '2024-03-01T10:00:00Z' },
        { id: '3', subject: 'Second', sender: 'a@b.com', sent_at: '2024-02-01T10:00:00Z' },
      ];
