...
const mockDb = {
  ...
  run: jest.fn((_sql: string, _params: unknown[], callback: (err: Error | null) => void) => {
...
describe('DatabaseService', () => {
  ...
  describe('User Operations', () => {
    ...
    describe('updateUser', () => {
      ...
      it('should throw error when no valid fields to update', async () => {
        await expect(
          databaseService.updateUser('user-123', { id: 'cannot-update' } as any)
    ...
    describe('acceptTerms', () => {
      it('should accept terms and return updated user', async () => {
        ...
        const user = await databaseService.acceptTerms('user-123', '1.0', '1.0');
  ...
  describe('Contact Operations', () => {
    ...
    describe('getContacts', () => {
      it('should return all contacts for a user', async () => {
        ...
        const contacts = await databaseService.getContacts({ user_id: 'user-123' });
      ...
      it('should filter by source', async () => {
        ...
        await databaseService.getContacts({ user_id: 'user-123', source: 'email' });
      ...
      it('should filter by is_imported', async () => {
        ...
        await databaseService.getContacts({ user_id: 'user-123', is_imported: true });
    ...
    describe('searchContacts', () => {
      it('should search contacts by name or email', async () => {
        ...
        const contacts = await databaseService.searchContacts('John', 'user-123');

        expect(contacts).toHaveLength(1);
        expect(mockStatement.all).toHaveBeenCalledWith('user-123', '%John%', '%John%');
      });
    });
  ...
  describe('Transaction Operations', () => {
    ...
    describe('getTransactions', () => {
      it('should return all transactions for a user', async () => {
        ...
        const transactions = await databaseService.getTransactions({ user_id: 'user-123' });
    ...
    describe('getTransactionById', () => {
      ...
      it('should return null when not found', async () => {
        ...
        const transaction = await databaseService.getTransactionById('non-existent');
  ...
  describe('SQL Injection Prevention', () => {
    ...
    it('should safely handle SQL injection in user email', async () => {
      ...
      mockStatement.get.mockReturnValue({ id: 'user-123', email: maliciousEmail });
  ...
  describe('Communication Operations', () => {
    ...
    describe('createCommunication', () => {
      it('should create communication with all fields', async () => {
        ...
        const communication = await databaseService.createCommunication(commData);
    ...
    describe('linkCommunicationToTransaction', () => {
      it('should update communication with transaction_id', async () => {
        await databaseService.linkCommunicationToTransaction('comm-123', 'txn-456');
  ...
  describe('Transaction Contact Operations', () => {
    ...
    describe('assignContactToTransaction', () => {
      it('should assign contact with role data', async () => {
        const result = await databaseService.assignContactToTransaction('txn-123', {
    ...
    describe('getTransactionContacts', () => {
      it('should return contacts for transaction', async () => {
        ...
        const contacts = await databaseService.getTransactionContacts('txn-123');
    ...
    describe('isContactAssignedToTransaction', () => {
      it('should return true when contact is assigned', async () => {
        ...
        const result = await databaseService.isContactAssignedToTransaction('txn-123', 'contact-456');
    ...
    describe('unlinkContactFromTransaction', () => {
      it('should remove contact from transaction', async () => {
        await databaseService.unlinkContactFromTransaction('txn-123', 'contact-456');

        expect(mockStatement.run).toHaveBeenCalledWith('txn-123', 'contact-456');
      });
    });
  });
  ...
  describe('OAuth Token Operations', () => {
    ...
    describe('getOAuthToken', () => {
      it('should return token when found', async () => {
        ...
        const token = await databaseService.getOAuthToken('user-123', 'google', 'authentication');
    ...
    describe('deleteOAuthToken', () => {
      it('should delete token by user, provider, and purpose', async () => {
        await databaseService.deleteOAuthToken('user-123', 'google', 'authentication');

        expect(mockStatement.run).toHaveBeenCalledWith('user-123', 'google', 'authentication');
      });
    });
  });
  ...
  describe('Audit Log Operations', () => {
    ...
    describe('getAuditLogs', () => {
      ...
      it('should filter by action', async () => {
        ...
        await databaseService.getAuditLogs({ userId: 'user-123', action: 'LOGIN' });
  ...
  describe('User Feedback Operations', () => {
    ...
    describe('getFeedbackByTransaction', () => {
      it('should return feedback for transaction', async () => {
        const mockFeedback = [
          { id: 'fb-1', field_name: 'closing_date', feedback_type: 'correction' },
        ];

        mockStatement.all.mockReturnValue(mockFeedback);

        const feedback = await databaseService.getFeedbackByTransaction('txn-123');
