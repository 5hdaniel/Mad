...
describe("MessagesService", () => {
  ...
  describe("getAllConversations", () => {
    ...
    it("should close database even on error", async () => {
      ...
      await expect(messagesService.getAllConversations()).rejects.toThrow(
        "Database error",
      );
    });
  ...
  describe("getGroupChatParticipants", () => {
    ...
    it("should handle database error", async () => {
      ...
      await expect(messagesService.getGroupChatParticipants(1)).rejects.toThrow(
        "Query failed",
      );
    });
  });
  ...
  describe("getMessagesForContact", () => {
    ...
    it("should return empty array when contact has undefined phones/emails", async () => {
      ...
      const messages = await messagesService.getMessagesForContact(
        contact as any,
      );
    ...
    it("should handle database error", async () => {
      ...
      await expect(
        messagesService.getMessagesForContact(contact),
  ...
  describe("getMessagesForChat", () => {
    ...
    it("should handle database error", async () => {
      ...
      await expect(messagesService.getMessagesForChat(1)).rejects.toThrow(
        "Chat query failed",
      );
    });
  });
  ...
  describe("getRecentChats", () => {
    ...
    it("should handle database error", async () => {
      ...
      await expect(messagesService.getRecentChats()).rejects.toThrow(
        "Recent chats query failed",
      );
    });
  });
