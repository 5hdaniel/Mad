...
describe('OutlookFetchService', () => {
  ...
  describe('initialize', () => {
    ...
    it('should throw error when no token found', async () => {
      ...
      await expect(outlookFetchService.initialize(mockUserId))
        .rejects.toThrow('No Outlook OAuth token found');
    });
  ...
  describe('searchEmails', () => {
    ...
    it('should throw error when not initialized', async () => {
      ...
      const uninitializedService = Object.create(Object.getPrototypeOf(outlookFetchService));
    ...
    it('should handle API errors', async () => {
      ...
      await expect(outlookFetchService.searchEmails({}))
  ...
  describe('getEmailById', () => {
    ...
    it('should handle fetch errors', async () => {
      ...
      await expect(outlookFetchService.getEmailById('invalid-id'))
  ...
  describe('getAttachments', () => {
    ...
    it('should fetch all attachments for a message', async () => {
      const mockAttachments = [
        { id: 'att-1', name: 'doc.pdf', contentType: 'application/pdf', size: 1024 },
        { id: 'att-2', name: 'image.jpg', contentType: 'image/jpeg', size: 2048 },
      ];
  ...
  describe('getAttachment', () => {
    ...
    it('should fetch specific attachment data', async () => {
      const attachmentContent = Buffer.from('attachment data').toString('base64');
      ...
      const result = await outlookFetchService.getAttachment('msg-123', 'att-456');

      expect(mockAxios).toHaveBeenCalledWith(expect.objectContaining({
        url: expect.stringContaining('/me/messages/msg-123/attachments/att-456'),
      }));
    ...
    it('should throw error when no contentBytes', async () => {
      ...
      await expect(outlookFetchService.getAttachment('msg-123', 'att-456'))
    ...
    it('should handle fetch errors', async () => {
      ...
      await expect(outlookFetchService.getAttachment('msg-123', 'invalid'))
  ...
  describe('getUserEmail', () => {
    ...
    it('should return mail property', async () => {
      mockAxios.mockResolvedValue({
        data: { mail: 'user@outlook.com', userPrincipalName: 'user@company.onmicrosoft.com' },
      });
    ...
    it('should handle errors', async () => {
      ...
      await expect(outlookFetchService.getUserEmail())
  ...
  describe('getFolders', () => {
    ...
    it('should handle errors', async () => {
      ...
      await expect(outlookFetchService.getFolders())
        .rejects.toThrow('Folders error');
    });
  });
});
