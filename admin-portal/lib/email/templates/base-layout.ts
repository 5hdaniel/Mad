 ...
 *
 * Duplicated from broker-portal/lib/email/templates/base-layout.ts because
 * the admin-portal is a separate Next.js app and cannot import from broker-portal.
 *
